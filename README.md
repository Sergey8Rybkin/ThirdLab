...
#### Из нашей папки переносим файлы в надлежащие папочки. Так-же нам нужно из импортированных ассетов выбрать все необходимые файлы и так-же перенести в соответсвующие папки.
